...
namespace lab1.Controllers
{
    public class NotasController : Controller
    {
        ...
        {
            using (Tbl_NotasEntities Empl = new Tbl_NotasEntities())
            {

                TblNotasEstudiante EliminarAlumno = Empl.TblNotasEstudiante.Where
                    (x => x.iDAlumno == id).FirstOrDefault();
                Empl.TblNotasEstudiante.Remove(EliminarAlumno);
                Empl.SaveChanges();
            }
